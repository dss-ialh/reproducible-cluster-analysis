...
read_chunk("./sandbox/kmeans-replica/kmeans-replica.R") 
```
...
## Basic Table
```{r basic-table-1, echo=T, results='show', message=FALSE}
```

```{r basic-table-2, echo=T, results='show', message=FALSE}
```


## Basic Graph
```{r basic-graph, echo=T, results='show', message=FALSE}
```
...
```{r dev-a-0, echo=T, results='show', message=FALSE}
```
...
## A6 - New Looping
```{r dev-a-6, echo=T, results='show', message=FALSE}
```
